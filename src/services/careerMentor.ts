import { CareerRoadmap, UserInput, YouTubeVideo } from '../types/career';
...
// Curated, high-signal YouTube suggestions by domain category for dynamic roadmaps
const youtubeByCategory: Record<string, YouTubeVideo[]> = {
  'Data Science': [
    {
      title: 'Data Science Roadmap 2025 (Skills and Projects)',
      channel: 'Krish Naik',
      url: 'https://www.youtube.com/watch?v=Zs_0I3K7GZg',
      duration: '1:10:00',
      views: '1M+',
      description: 'Updated roadmap and skills to become a data scientist with projects.'
    },
    {
      title: 'Hands-on Machine Learning with Scikit-Learn (Full Course)',
      channel: 'freeCodeCamp.org',
      url: 'https://www.youtube.com/watch?v=7eh4d6sabA0',
      duration: '3:17:00',
      views: '4M+',
      description: 'Practical ML using Python and scikit-learn end to end.'
    }
  ],
  'Web Development': [
    {
      title: 'Web Developer Roadmap 2025',
      channel: 'Traversy Media',
      url: 'https://www.youtube.com/watch?v=0pThnRneDjw',
      duration: '1:20:00',
      views: '2M+',
      description: 'Modern full-stack roadmap, tools, and best practices.'
    },
    {
      title: 'React 18 & TypeScript Crash Course',
      channel: 'Net Ninja',
      url: 'https://www.youtube.com/watch?v=H2x8Q5OBUo0',
      duration: '2:05:00',
      views: '1M+',
      description: 'React with TypeScript for scalable frontends.'
    }
  ],
  'Mobile Development': [
    {
    ...
    {
      title: 'React Native Tutorial - Build a Mobile App',
      channel: 'Programming with Mosh',
      url: 'https://www.youtube.com/watch?v=0-S5a0eXPoc',
      duration: '2:15:00',
      views: '2M+',
      description: 'React Native fundamentals and patterns.'
    }
  ],
  'Cybersecurity': [
    {
      ...
      channel: 'freeCodeCamp.org',
      url: 'https://www.youtube.com/watch?v=1useKz5-6xI',
      duration: '12:00:00',
      views: '1M+',
      description: 'Foundations, network security, and tools.'
    },
    {
      ...
      duration: '15:30:00',
      views: '3M+',
      description: 'Practical ethical hacking with labs.'
    }
  ],
  'UI/UX Design': [
    {
      ...
      url: 'https://www.youtube.com/watch?v=F4kJXBaMvTg',
      duration: '1:40:00',
      views: '900K',
      description: 'Principles, tools, and portfolio tips.'
    }
  ],
  'DevOps': [
    {
      ...
      duration: '1:25:00',
      views: '2M+',
      description: 'Docker, Kubernetes, CI/CD, cloud essentials.'
    }
  ],
  default: [
    {
      title: 'How to Learn Anything Fast (Tech Edition)',
      channel: 'Fireship',
      url: 'https://www.youtube.com/watch?v=KjjZVQpzT3U',
      duration: '10:00',
      views: '2M+',
      description: 'High-level strategies for accelerating learning in tech.'
    }
  ]
};

function buildDynamicRoadmap(domain: string, interests: string, skills: string): CareerRoadmap {
  const normalized = `${domain} ${interests} ${skills}`.toLowerCase();

  // Pick a category for suggestions
  const category = Object.keys(youtubeByCategory).find(cat => normalized.includes(cat.toLowerCase())) || 'default';

  // Simple heuristic skill blocks
  const baseBeginner = ['Foundations and terminology', 'Essential tooling setup', 'Version control with Git', 'Beginner project'];
  const baseIntermediate = ['Core workflows and patterns', 'APIs and data handling', 'Testing and debugging', 'Portfolio project'];
  const baseAdvanced = ['Scaling and performance', 'Security and best practices', 'Deployment/DevOps basics', 'Capstone project'];

  const topicHints: Record<string, { beginner: string[]; intermediate: string[]; advanced: string[] }> = {
    'data': {
      beginner: ['Python + Pandas basics', 'Statistics 101', 'Data visualization basics'],
      intermediate: ['Feature engineering', 'Supervised ML with scikit-learn', 'SQL for analytics'],
      advanced: ['Deep learning intro (TensorFlow/PyTorch)', 'MLOps overview', 'Big data tooling (Spark)']
    },
    'web': {
      beginner: ['HTML/CSS', 'Modern JavaScript', 'Responsive layout'],
      intermediate: ['React basics', 'APIs with Node/Express', 'Database basics'],
      advanced: ['System design basics', 'Performance & accessibility', 'Cloud deploy (Vercel/AWS)']
    },
    'mobile': {
      beginner: ['Dart/Flutter or React Native basics', 'Mobile UI patterns', 'Navigation'],
      intermediate: ['State management', 'Offline storage', 'APIs and auth'],
      advanced: ['Performance profiling', 'Store release pipeline', 'Analytics & crash reporting']
    },
    'security': {
      beginner: ['Networking basics', 'Linux CLI', 'Security fundamentals'],
      intermediate: ['Web app security (OWASP)', 'Tooling: Nmap/Burp', 'Reports & remediation'],
      advanced: ['Threat modeling', 'Cloud security basics', 'Blue/Red team workflows']
    }
  };

  const hintKey = Object.keys(topicHints).find(k => normalized.includes(k)) || (normalized.includes('devops') ? 'security' : 'web');
  const hints = topicHints[hintKey];

  const pickVideos = youtubeByCategory[category] || youtubeByCategory.default;
  ...
  return {
    ...
    roadmap: [
      {
        phase: 'Beginner',
        skills: [...baseBeginner, ...hints.beginner],
        free_resources: [
        ...
        projects: ['Mini project based on your interests'],
        youtube_videos: pickVideos
      },
      {
        phase: 'Intermediate',
        skills: [...baseIntermediate, ...hints.intermediate],
        free_resources: [
          'https://roadmap.sh/|roadmap.sh guides',
          'https://stackabuse.com/|StackAbuse articles'
        ],
        paid_resources: [
          'https://frontendmasters.com/|Frontend Masters',
          'https://www.educative.io/|Educative'
        ],
        projects: ['Portfolio-ready project with real API/data'],
        youtube_videos: pickVideos
      },
      {
        phase: 'Advanced',
        skills: [...baseAdvanced, ...hints.advanced],
        free_resources: [
        ...
        projects: ['Capstone with deployment and documentation'],
        youtube_videos: pickVideos
      }
    ],
    career_paths: ['Entry-level role', 'Mid-level role', 'Specialist/Advanced role'],
    companies: ['Any modern tech-driven company'],
    interview_prep: ['Behavioral questions', 'Role-specific problem solving', 'Portfolio/code review']
  };
}
...
export function generateCareerRoadmap(userInput: UserInput): CareerRoadmap {
  ...
  const template = roadmapTemplates[bestDomain];
  if (!template) {
    // Build a dynamic roadmap if no predefined template exists
    return buildDynamicRoadmap(bestDomain, userInput.interests, userInput.skills);
  }
